...
# To download the GoogleNews word embedding: https://www.kaggle.com/sandreds/googlenewsvectorsnegative300#GoogleNews-vectors-negative300.bin
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        if dev_acc > best_dev_acc:
            ...
            torch.save(best_model, './data/modelLSTM.pt')
